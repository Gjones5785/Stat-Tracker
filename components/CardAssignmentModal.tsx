...
export const CardAssignmentModal: React.FC<CardAssignmentModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div className={`relative bg-white rounded-xl shadow-2xl max-w-sm w-full p-6 border ${borderColor} animate-in fade-in zoom-in duration-200`}>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-xs font-bold uppercase text-gray-500 mb-1">Select Player</label>
            <select
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm bg-white text-gray-900 placeholder-gray-400"
              rows={3}
