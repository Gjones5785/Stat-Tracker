...
export const SettingsModal: React.FC<SettingsModalProps> = ({
  ...
  const [activeTab, setActiveTab] = useState<'branding' | 'rules' | 'prefs' | 'guide' | 'account' | 'data'>('branding');
  ...
  const handleExport = () => {
    ...
    link.href = url;
    link.download = `leaguelens-backup-${new Date().toISOString().split('T')[0]}.json`;
          ...
          {activeTab === 'data' && (
            <div className="space-y-6 animate-in fade-in slide-in-from-top-4 duration-300">
               <div className="text-center mb-6">
                  <h3 className="text-2xl font-heading font-black text-slate-900 dark:text-white uppercase tracking-tight mb-2">Data Management</h3>
                  <p className="text-sm text-gray-500 font-medium">Export your local and cloud data for backup.</p>
               </div>
               ...
               <div className="p-6 bg-gray-50 dark:bg-white/5 rounded-3xl border border-gray-100 dark:border-white/5">
                  <div className="flex items-center space-x-4 mb-4">
                     ...
                     <div>
                        <h4 className="text-lg font-heading font-bold text-slate-900 dark:text-white">Full Backup</h4>
                        <p className="text-xs text-gray-500 uppercase font-black tracking-widest">JSON Format</p>
                     </div>
                  </div>
                  <p className="text-sm text-slate-600 dark:text-gray-400 mb-6 leading-relaxed">
                     Download a complete archive of your squad, match history, training sessions, playbook, and coaching actions. This file can be used to restore your data or for external analysis.
                  </p>
                  <Button 
                    onClick={handleExport}
                    className="w-full bg-slate-900 dark:bg-white dark:text-slate-900 py-4 rounded-2xl shadow-xl flex items-center justify-center space-x-3 active:scale-95 transition-all group"
                  >
                    <span className="font-black uppercase tracking-widest text-xs">Download Backup File</span>
               ...
               <div className="p-6 bg-blue-50 dark:bg-blue-900/10 rounded-3xl border border-blue-100 dark:border-blue-900/20 flex items-start space-x-4">
                  ...
                  <div>
                     <h4 className="text-sm font-bold text-blue-900 dark:text-blue-400 mb-1">Cloud Storage</h4>
                     <p className="text-xs text-blue-700 dark:text-blue-500/80 leading-relaxed">
                        Your data is already securely backed up to the cloud in real-time. This manual export is intended for personal archives or offline use.
                     </p>
                  </div>
               </div>
            </div>
